...
import { ClassificationResultOrmEntity } from '../../infrastructure/database/typeorm/entities/classification-result.orm-entity';
 ...
 */
export function buildTypeOrmConfig(config: ConfigService<EnvConfig, true>): TypeOrmModuleOptions {
  return {
    type: 'postgres',
    ...
    entities: [ReportOrmEntity, ClassificationResultOrmEntity],
